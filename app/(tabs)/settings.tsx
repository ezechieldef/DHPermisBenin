...
import { PERMIT_TYPES, type PermitType, type TextScale, type ThemeMode, useThemePreferences } from '@/src/theme/preferences';
...
export default function SettingsScreen() {
  const { colors, mode, selectedPermitTypes, setMode, textScale, setTextScale, togglePermitType } = useThemePreferences();
